...
//import Femtocraft;
//import IInterfaceDevice;
//import TileContainer;
//import ProxyClient;
//import TileEntityVacuumHub;
//import TileEntityVacuumTube;
...
//
//public class BlockVacuumHub extends TileContainer {
...
//        TileEntityVacuumHub hub = (TileEntityVacuumHub) tile;
//
//        AxisAlignedBB inputBB = boundingBoxForDirection(hub.getInput(), x, y,
//                z);
//        if (par5AxisAlignedBB.intersectsWith(inputBB)) {
//            par6List.add(inputBB);
//        }
//
//        AxisAlignedBB outputBB = boundingBoxForDirection(hub.getOutput(), x,
//                y, z);
