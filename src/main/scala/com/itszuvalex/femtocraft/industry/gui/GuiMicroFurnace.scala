...
import com.itszuvalex.femtocraft.industry.gui.GuiMicroFurnace._
...
@SideOnly(Side.CLIENT) object GuiMicroFurnace {
  val texture = new ResourceLocation(Femtocraft.ID.toLowerCase, "textures/guis/MicroFurnace.png")
}

@SideOnly(Side.CLIENT) class GuiMicroFurnace(player: EntityPlayer, par1InventoryPlayer: InventoryPlayer, par2TileEntityFurnace: TileEntityBaseEntityMicroFurnace) extends GuiBase(new ContainerMicroFurnace(player, par1InventoryPlayer, par2TileEntityFurnace)) {
