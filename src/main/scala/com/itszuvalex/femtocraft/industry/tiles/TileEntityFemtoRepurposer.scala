...
import com.itszuvalex.femtocraft.industry.tiles.TileEntityFemtoRepurposer._
import com.itszuvalex.femtocraft.research.FemtocraftTechnologies
import com.itszuvalex.femtocraft.{Femtocraft, FemtocraftGuiConstants}

object TileEntityFemtoRepurposer {
...
@Configurable class TileEntityFemtoRepurposer extends TileEntityBaseEntityMicroDeconstructor {
  override def defaultContainer = new PowerContainer(TECH_LEVEL, POWER_STORAGE)

  override def getGuiID = FemtocraftGuiConstants.FemtoRepurposerGuiID
