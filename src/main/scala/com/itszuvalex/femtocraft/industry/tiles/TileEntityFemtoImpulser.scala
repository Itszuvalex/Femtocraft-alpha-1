...
import com.itszuvalex.femtocraft.industry.tiles.TileEntityFemtoImpulser._
import com.itszuvalex.femtocraft.research.FemtocraftTechnologies
import com.itszuvalex.femtocraft.{Femtocraft, FemtocraftGuiConstants}

object TileEntityFemtoImpulser {
...
@Configurable class TileEntityFemtoImpulser extends TileEntityBaseEntityMicroFurnace {
  override def defaultContainer = new PowerContainer(TECH_LEVEL, POWER_STORAGE)

  override def getGuiID = FemtocraftGuiConstants.FemtoImpulserGuiID
  ...
  protected override def updateBlockState(working: Boolean) {
    BlockFemtoImpulser.updateFurnaceBlockState(working, worldObj, xCoord, yCoord, zCoord)
  }
}