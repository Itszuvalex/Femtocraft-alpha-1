...
@SideOnly(Side.CLIENT) class RenderDimensionalTear extends TileEntitySpecialRenderer {
  private var field_147528_b: FloatBuffer = GLAllocation.createDirectFloatBuffer(16)
  ...
  def renderTileEntityAt(p_147500_1_ : TileEntityDimensionalTear, p_147500_2_ : Double, p_147500_4_ : Double, p_147500_6_ : Double, p_147500_8_ : Float) {
    ...
    for (i <- 0 until 16) {
      ...
      if (i == 1) {
        this.bindTexture(pictureLocation)
        GL11.glEnable(GL11.GL_BLEND)
        GL11.glBlendFunc(GL11.GL_ONE, GL11.GL_ONE)
        f6 = 0.5F
      }
      val f8: Float = (-(p_147500_4_ + height.toDouble)).toFloat
      var f9: Float = f8 + ActiveRenderInfo.objectY
      val f10: Float = f8 + f5 + ActiveRenderInfo.objectY
      var f11: Float = f9 / f10
      f11 += (p_147500_4_ + height.toDouble).toFloat
      ...
      GL11.glRotatef((i * i * 4321 + i * 9).toFloat * 2.0F, 0.0F, 0.0F, 1.0F)
      GL11.glTranslatef(-0.5F, -0.5F, 0.0F)
      ...
      //render top
      tessellator.addVertex(p_147500_2_, p_147500_4_ + height.toDouble, p_147500_6_)
      tessellator.addVertex(p_147500_2_, p_147500_4_ + height.toDouble, p_147500_6_ + 1.0D)
      tessellator.addVertex(p_147500_2_ + 1.0D, p_147500_4_ + height.toDouble, p_147500_6_ + 1.0D)
      tessellator.addVertex(p_147500_2_ + 1.0D, p_147500_4_ + height.toDouble, p_147500_6_)
      //render bot
