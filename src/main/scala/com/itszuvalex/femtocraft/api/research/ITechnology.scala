...
trait ITechnology {
   ...
   */
  def getResearchMaterials: Array[ItemStack]
   ...
   */
  def getResearchedDescription: String
   ...
   */
  def getDiscoveredDescription: String
