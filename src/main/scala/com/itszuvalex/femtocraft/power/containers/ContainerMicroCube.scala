...
class ContainerMicroCube(private val cube: TileEntityMicroCube) extends ContainerBase {
  ...
  override def detectAndSendChanges() {
    ...
    val power = cube.getCurrentPower
  ...
  def canInteractWith(entityplayer: EntityPlayer): Boolean = cube.canPlayerUse(entityplayer)
}
