...
//        locToSoundIDMap = new HashMap<>();
//        soundIDToLocMap = new HashMap<>();
//        waitForEventList = new HashSet<>();
//    }
//
...
//        packet.channel = com.itszuvalex.femtocraft.sound.FemtocraftSoundManager.PACKET_CHANNEL;
//
