...
public class BlockNanoHorologe extends TileContainer {
    /**
    ...
    public BlockNanoHorologe(int par1) {
    ...
    public TileEntity createNewTileEntity(World par1World) {
        return new TileEntityBaseEntityNanoHorologe();
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4,
                           int par5, int par6) {
        TileEntityBaseEntityNanoHorologe tileEntity =
