...
class BlockMicroReconstructor extends TileContainer(Material.iron) with DroppableInventory with RotateOnPlace {
  /**
   ...
   */
  override def createNewTileEntity(par1World: World, metadata: Int) = new TileEntityBaseEntityMicroReconstructor
