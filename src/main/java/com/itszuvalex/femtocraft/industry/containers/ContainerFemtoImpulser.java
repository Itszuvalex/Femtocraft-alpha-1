...
public class ContainerFemtoImpulser extends Container {
    private TileEntityFemtoImpulser furnace;
    private int lastCookTime = 0;
    private int lastPower = 0;

    public ContainerFemtoImpulser(InventoryPlayer par1InventoryPlayer,
