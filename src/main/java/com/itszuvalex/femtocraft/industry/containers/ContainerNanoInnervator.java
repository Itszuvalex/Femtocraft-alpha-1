...
public class ContainerNanoInnervator extends Container {
    private TileEntityNanoInnervator furnace;
    private int lastCookTime = 0;
    private int lastPower = 0;

    public ContainerNanoInnervator(InventoryPlayer par1InventoryPlayer,
    ...
    public boolean canInteractWith(EntityPlayer par1EntityPlayer) {
        return this.furnace.canPlayerUse(par1EntityPlayer);
    }
}
