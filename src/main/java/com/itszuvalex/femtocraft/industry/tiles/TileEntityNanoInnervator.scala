...
import com.itszuvalex.femtocraft.industry.tiles.TileEntityNanoInnervator._
import com.itszuvalex.femtocraft.research.FemtocraftTechnologies
import com.itszuvalex.femtocraft.{Femtocraft, FemtocraftGuiConstants}

object TileEntityNanoInnervator {
...
@Configurable class TileEntityNanoInnervator extends TileEntityBaseEntityMicroFurnace {
  override def defaultContainer = new PowerContainer(TECH_LEVEL, POWER_STORAGE)

  override def getGuiID = FemtocraftGuiConstants.NanoInnervatorGuiID
  ...
  protected override def updateBlockState(working: Boolean) {
    BlockNanoInnervator.updateFurnaceBlockState(working, worldObj, xCoord, yCoord, zCoord)
  }
}
