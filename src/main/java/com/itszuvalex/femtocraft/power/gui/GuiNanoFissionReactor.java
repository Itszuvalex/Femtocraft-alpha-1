...
public class GuiNanoFissionReactor extends GuiBase {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRendererObj.drawString(s,
                (110 + 25) / 2 - this.fontRendererObj.getStringWidth(s) / 2, 6,
        ...
        String abort = "ABORT";
        this.fontRendererObj.drawString(abort,
                (abortButtonX + (abortButtonWidth) / 2) - ((this.fontRendererObj.getStringWidth(abort) /
        ...
        this.fontRendererObj.drawString(concentrationTarget,
                112 + (127 - 112) / 2 - this.fontRendererObj.getStringWidth(concentrationTarget) / 2,
                48 + (58 - 48) / 2 -
        ...
        this.fontRendererObj.drawString(currentConcentration,
                90 + (104 - 90) / 2 - this.fontRendererObj.getStringWidth(currentConcentration) / 2,
                51 + (61 - 51) / 2 -
                this.fontRendererObj
                        .FONT_HEIGHT /
                2,
