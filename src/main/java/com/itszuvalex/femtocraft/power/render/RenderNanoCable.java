 ...
 * @author Chris
 */
public class RenderNanoCable implements ISimpleBlockRenderingHandler {
    ...
    private boolean renderCable(BlockNanoCable cable, float x, float y, float z, boolean[] connections) {
        ...
        // //Render border
        // renderer.setOverrideBlockTexture(BlockNanoCable.coreBorder);
    ...
    private void drawCore(BlockNanoCable cable, float x, float y, float z, boolean[] connections) {
        if (!CoilInitialized) {
        ...
        if (!connectedAcross(connections)) {
            ...
            if (connections[0]) {
                ...
                // drawCoil(BlockNanoCable, x, y, z, 2.0F/16.0F, renderer,
    ...
    private void initializeCoils(BlockNanoCable cable) {
    ...
    // private void drawCoil(BlockNanoCable BlockNanoCable, float x, float y, float z,
    // float offset, RenderBlocks renderer, ForgeDirection direction) {
    //
    // drawConnector(BlockNanoCable, x, y, z, 1.0F/16.0F + offset, renderer, direction,
    // true);
    // drawConnector(BlockNanoCable, x, y, z, -1.0F/16.0F + offset, renderer, direction,
    // false);
    //
    // if(!CoilInitialized)
    // initializeCoils(BlockNanoCable);
    //
    ...
    private void drawCoilClose(BlockNanoCable cable, ForgeDirection dir,
                               RenderPoint loc) {
    ...
    private void drawCoilFar(BlockNanoCable cable, ForgeDirection dir,
                             RenderPoint loc) {
    ...
    private RenderModel createCoil(BlockNanoCable cable, float offset) {
    ...
    private void drawConnector(BlockNanoCable cable, float x, float y, float z, float offset, ForgeDirection direction, boolean drawCap) {
