...
object AssemblerDefaults {
  ...
  def getMicroDefaults: ArrayBuffer[AssemblerRecipe] = {
    ...
    ret += new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemConductiveAlloy), new ItemStack(Femtocraft.itemMorphicChannel), null,
                                                null, null, null,
                                                null, null, null), 1, new ItemStack(Femtocraft.itemDustFarenite), EnumTechLevel.NANO, FemtocraftTechnologies.THORIUM_FISSIBILITY)
  ...
  def getFemtocraftDefaults: ArrayBuffer[AssemblerRecipe] = {
    ...
    ret += new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.quartz),
                                                new ItemStack(Femtocraft.itemDustFarenite),
    ...
    ret += new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.comparator),
                               ...
                               FemtocraftTechnologies.NANO_CIRCUITS)
    ret += new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemDustFarenite),
                                                new ItemStack(Items.redstone),
    ...
    ret += new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.quartz), null, null,
                                                new ItemStack(Femtocraft.itemDustFarenite), null, null,
    ...
    ret += new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemNanochip),
                               ...
                               FemtocraftTechnologies.HARNESSED_NUCLEAR_DECAY)
    ret += new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemDustFarenite), null,
                                                new ItemStack(Femtocraft.itemDustFarenite),
                                                new ItemStack(Femtocraft.itemIngotThorium),
                                                new ItemStack(Femtocraft.itemDustFarenite),
                                                new ItemStack(Femtocraft.itemIngotThorium),
                                                new ItemStack(Femtocraft.itemDustFarenite), null,
                                                new ItemStack(Femtocraft.itemDustFarenite)), 0,
    ...
    ret += new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemInfiniteVolumePolychora),
                                                ...
                                                new ItemStack(Femtocraft.itemStellaratorPlating),
                                                new ItemStack(Femtocraft.itemInfinitelyRecursiveALU)), 0,
