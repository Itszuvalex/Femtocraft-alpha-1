...
class ManagerAssemblerRecipe {
  ...
  def registerDefaultRecipes() {
    ...
    val recipes = CraftingManager.getInstance.getRecipeList.filter(i => i != null && i.isInstanceOf[IRecipe])
  ...
  @throws(classOf[IllegalArgumentException])
  def addRecipe(recipe: AssemblerRecipe): Boolean = recipe.`type` match {
  ...
  private def normalizedItem(original: ItemStack) = if (original == null) {
    null
  }
                                                    else {
                                                      new ItemStack(original.getItem, 1, original.getItemDamage)
                                                    }
  ...
  private def registerRecipes() {
    ...
    new AssemblerXMLLoader(new File(FemtocraftFileUtils.customConfigPath + "Assembler/")).loadItems().foreach(addRecipe)
    ...
    if (!test.initialized) {
      ...
      test.seedInitialRecipes(defaults)
    }
    else {
      test.loadCustomRecipes().foreach(addRecipe)
    }
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemCrystallite, 2),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null, new ItemStack(Femtocraft.itemFaunite),
  //                                                             new ItemStack(Femtocraft.itemMineralite),
  //                                                             new ItemStack(Femtocraft.itemFaunite), null, null, null),
  //                                            2, new ItemStack(Femtocraft.itemProteinChain), EnumTechLevel.NANO,
  //                                            FemtocraftTechnologies.ADVANCED_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null, new ItemStack(Femtocraft.itemFaunite),
  //                                                             new ItemStack(Femtocraft.itemElectrite),
  //                                                             new ItemStack(Femtocraft.itemFaunite), null, null, null),
  //                                            2, new ItemStack(Femtocraft.itemNerveCluster), EnumTechLevel.NANO,
  //                                            FemtocraftTechnologies.ADVANCED_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemMetallite), null,
  //                                                             new ItemStack(Femtocraft.itemElectrite),
  //                                                             new ItemStack(Femtocraft.itemElectrite),
  ...
  //                                            FemtocraftTechnologies.ADVANCED_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemMineralite), null,
  ...
  //                                            FemtocraftTechnologies.ADVANCED_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null, new ItemStack(Femtocraft.itemFlorite),
  //                                                             null, new ItemStack(Femtocraft.itemMineralite), null, null,
  //                                                             null), 2, new ItemStack(Femtocraft.itemFibrousStrand),
  //                                            EnumTechLevel.NANO, FemtocraftTechnologies.ADVANCED_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null, new ItemStack(Femtocraft.itemMineralite),
  ...
  //                                                             new ItemStack(Femtocraft.itemFlorite), null, null, null),
  //                                            2, new ItemStack(Femtocraft.itemFungalSpores), EnumTechLevel.NANO,
  //                                            FemtocraftTechnologies.ADVANCED_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null, new ItemStack(Femtocraft.itemElectrite),
  //                                                             new ItemStack(Femtocraft.itemMineralite),
  //                                                             new ItemStack(Femtocraft.itemElectrite), null, null, null),
  //                                            2, new ItemStack(Femtocraft.itemIonicChunk), EnumTechLevel.NANO,
  //                                            FemtocraftTechnologies.ADVANCED_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null, new ItemStack(Femtocraft.itemFlorite),
  //                                                             new ItemStack(Femtocraft.itemFaunite),
  //                                                             new ItemStack(Femtocraft.itemFlorite), null, null, null),
  //                                            2, new ItemStack(Femtocraft.itemReplicatingMaterial), EnumTechLevel.NANO,
  //                                            FemtocraftTechnologies.ADVANCED_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null,
  //                                                             new ItemStack(Femtocraft.itemCrystallite),
  //                                                             new ItemStack(Femtocraft.itemFaunite),
  ...
  //                                                             new ItemStack(Femtocraft.itemElectrite), null, null, null),
  //                                            2, new ItemStack(Femtocraft.itemMorphicChannel), EnumTechLevel.NANO,
  //                                            FemtocraftTechnologies.ADVANCED_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null, new ItemStack(Femtocraft.itemFlorite),
  //                                                             new ItemStack(Femtocraft.itemMetallite),
  //                                                             new ItemStack(Femtocraft.itemFlorite), null, null, null),
  //                                            2, new ItemStack(Femtocraft.itemSynthesizedFiber), EnumTechLevel.NANO,
  //                                            FemtocraftTechnologies.ADVANCED_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemMetallite), null,
  //                                                             new ItemStack(Femtocraft.itemFaunite),
  //                                                             new ItemStack(Femtocraft.itemFaunite),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMineralLattice), null, null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.stone), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.grass), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, new ItemStack(Femtocraft.itemMineralLattice),
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.dirt), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemMineralLattice), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.cobblestone), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemFibrousStrand),
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.planks), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null),
  //                                            1, new ItemStack(Blocks.sapling), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMicroCrystal), null, null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.sand), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemFibrousStrand), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.leaves), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemSpinyFilament), null, null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.web), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, new ItemStack(Femtocraft.itemFibrousStrand),
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.deadbush), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             new ItemStack(Femtocraft.itemMorphicChannel), null, null,
  //                                                             null, null, null), 1, new ItemStack(Blocks.yellow_flower),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemFibrousStrand), null,
  //                                                             null, new ItemStack(Femtocraft.itemMorphicChannel), null,
  //                                                             null, null, null), 1, new ItemStack(Blocks.red_flower),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemFungalSpores), null, null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.brown_mushroom), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemFungalSpores), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.red_mushroom), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMineralLattice),
  //                                                             new ItemStack(Femtocraft.itemFungalSpores), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.mossy_cobblestone), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemHardenedBulb), null, null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.obsidian), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemMicroCrystal), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.ice), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemSpinyFilament), null, null,
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             null, null, null), 1, new ItemStack(Blocks.cactus),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemFibrousStrand),
  //                                                             new ItemStack(Femtocraft.itemMorphicChannel), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.pumpkin), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null,
  //                                                             new ItemStack(Femtocraft.itemMineralLattice), null, null,
  //                                                             null, null, null), 1, new ItemStack(Blocks.netherrack),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMicroCrystal),
  //                                                             new ItemStack(Femtocraft.itemIonicChunk), null, null, null,
  //                                                             null, null, null, null), 1,
  //                                            new ItemStack(Blocks.soul_sand), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemConductiveAlloy),
  //                                                             new ItemStack(Femtocraft.itemIonicChunk), null, null, null,
  //                                                             null, null, null, null), 1,
  //                                            new ItemStack(Items.glowstone_dust), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMorphicChannel),
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.melon_block), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null,
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             null, null, null), 1, new ItemStack(Blocks.vine),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemFungalSpores),
  //                                                             new ItemStack(Femtocraft.itemMineralLattice), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.mycelium), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null, null,
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             null, null), 1, new ItemStack(Blocks.waterlily),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemConductiveAlloy),
  //                                                             new ItemStack(Femtocraft.itemMineralLattice), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.end_stone), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMorphicChannel), null, null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Blocks.cocoa), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemFibrousStrand), null,
  //                                                             new ItemStack(Femtocraft.itemMorphicChannel), null, null,
  //                                                             null, null, null, null), 1, new ItemStack(Items.apple),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMineralLattice),
  //                                                             new ItemStack(Femtocraft.itemIonicChunk), null, null, null,
  //                                                             null, null, null, null), 1, new ItemStack(Items.coal),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMicroCrystal, 8),
  ...
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMetalComposite), null, null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.iron_ingot), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMetalComposite),
  //                                                             new ItemStack(Femtocraft.itemHardenedBulb), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.gold_ingot), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null, null, null,
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             null), 1, new ItemStack(Items.stick), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemReplicatingMaterial), null,
  //                                                             null, null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.string), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemSpinyFilament), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.feather), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemIonicChunk),
  //                                                             new ItemStack(Femtocraft.itemNerveCluster), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.gunpowder), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemReplicatingMaterial),
  //                                                             null, null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.wheat_seeds), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemReplicatingMaterial),
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.wheat), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemHardenedBulb), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.flint), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemReplicatingMaterial),
  //                                                             new ItemStack(Femtocraft.itemNerveCluster), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.porkchop), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemProteinChain), null, null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.cooked_porkchop), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemIonicChunk),
  //                                                             new ItemStack(Femtocraft.itemMineralLattice), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.redstone), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null, null, null, null, null, null,
  //                                                             new ItemStack(Femtocraft.itemMineralLattice)), 1,
  //                                            new ItemStack(Items.snowball), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemProteinChain),
  //                                                             new ItemStack(Femtocraft.itemSynthesizedFiber), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.leather), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemIonicChunk), null, null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.clay_ball), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemSynthesizedFiber), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.reeds), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemNerveCluster), null, null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.slime_ball), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemNerveCluster),
  //                                                             new ItemStack(Femtocraft.itemReplicatingMaterial), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.egg), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemReplicatingMaterial), null,
  //                                                             null, new ItemStack(Femtocraft.itemNerveCluster), null,
  //                                                             null, null, null, null), 1, new ItemStack(Items.fish),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemProteinChain),
  //                                                             new ItemStack(Femtocraft.itemSpinyFilament), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.cooked_fished), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemReplicatingMaterial),
  //                                                             new ItemStack(Femtocraft.itemSynthesizedFiber), null, null,
  //                                                             null, null, null, null, null), 1,
  ...
  //                                                             new ItemStack(Femtocraft.itemHardenedBulb), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.bone), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemHardenedBulb),
  //                                                             new ItemStack(Femtocraft.itemReplicatingMaterial), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.pumpkin_seeds), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemHardenedBulb),
  //                                                             new ItemStack(Femtocraft.itemReplicatingMaterial), null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.melon_seeds), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemNerveCluster),
  //                                                             new ItemStack(Femtocraft.itemReplicatingMaterial), null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.beef), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemProteinChain), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.cooked_beef), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemNerveCluster), null, null,
  //                                                             new ItemStack(Femtocraft.itemReplicatingMaterial), null,
  //                                                             null, null, null, null), 1, new ItemStack(Items.chicken),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, new ItemStack(Femtocraft.itemProteinChain),
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.cooked_chicken), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemSpinyFilament),
  //                                                             new ItemStack(Femtocraft.itemNerveCluster), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.rotten_flesh), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemIonicChunk), null,
  ...
  //                                                             new ItemStack(Femtocraft.itemIonicChunk), null, null, null,
  //                                                             null, null, null, null), 1,
  //                                            new ItemStack(Items.ghast_tear), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemFungalSpores),
  //                                                             new ItemStack(Femtocraft.itemReplicatingMaterial), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.nether_wart), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemNerveCluster),
  //                                                             new ItemStack(Femtocraft.itemOrganometallicPlate), null,
  //                                                             null, null, null, null, null, null), 1,
  //                                            new ItemStack(Items.spider_eye), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMorphicChannel),
  //                                                             new ItemStack(Femtocraft.itemMicroCrystal), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.blaze_powder), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMetalComposite),
  //                                                             new ItemStack(Femtocraft.itemConductiveAlloy), null, null,
  //                                                             null, null, null, null, null), 1,
  //                                            new ItemStack(Items.emerald), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemReplicatingMaterial),
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             null, null, null, null), 1, new ItemStack(Items.carrot),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null,
  //                                                             new ItemStack(Femtocraft.itemReplicatingMaterial),
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null,
  //                                                             null, null), 1, new ItemStack(Items.potato),
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null, null, null, null,
  //                                                             new ItemStack(Femtocraft.itemFibrousStrand), null, null),
  //                                            1, new ItemStack(Items.baked_potato), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, null, null,
  //                                                             new ItemStack(Femtocraft.itemSynthesizedFiber), null, null,
  //                                                             null, null, null), 1,
  //                                            new ItemStack(Items.poisonous_potato), EnumTechLevel.MICRO,
  //                                            FemtocraftTechnologies.BASIC_CHEMISTRY))
  //    addDecompositionRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.egg), new ItemStack(Items.sugar, 2),
  //                                                                new ItemStack(Items.wheat, 3), null, null, null, null,
  //                                                                null, null), 1, new ItemStack(Items.cake),
  //                                               EnumTechLevel.MACRO, FemtocraftTechnologies.MACROSCOPIC_STRUCTURES))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemHardenedBulb, 64),
  ...
  //    addDecompositionRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.paper, 3), null, null, null, null,
  //                                                                null, null, null, null), 0,
  //                                               new ItemStack(Femtocraft.itemPaperSchematic), EnumTechLevel.MACRO,
  //                                               FemtocraftTechnologies.ALGORITHMS))
  //    addRecompositionRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemSpoolGold),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemIngotTemperedTitanium),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.quartz),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.comparator),
  //                                                             new ItemStack(Femtocraft.itemIngotFarenite),
  ...
  //                                            FemtocraftTechnologies.NANO_CIRCUITS))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemIngotFarenite),
  //                                                             new ItemStack(Items.redstone),
  ...
  //                                            FemtocraftTechnologies.NANO_CIRCUITS))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.quartz), null, null,
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemNanoCalculator),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemNanoSimulator), null,
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemNanoRegulator), null, null,
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemNanoPlating),
  ...
  //                                            FemtocraftTechnologies.FARENITE_STABILIZATION))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.quartz), new ItemStack(Items.quartz),
  //                                                             new ItemStack(Items.quartz),
  ...
  //                                            EnumTechLevel.MICRO, FemtocraftTechnologies.GEOTHERMAL_HARNESSING))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemNanoRegulator),
  //                                                             new ItemStack(Items.quartz),
  //                                                             new ItemStack(Femtocraft.itemNanoRegulator),
  ...
  //                                            FemtocraftTechnologies.SPACETIME_MANIPULATION))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.iron_ingot),
  ...
  //                                            FemtocraftTechnologies.SPACETIME_MANIPULATION))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemIngotPlatinum),
  //                                                             new ItemStack(Femtocraft.itemIngotPlatinum),
  //                                                             new ItemStack(Femtocraft.itemIngotPlatinum),
  //                                                             new ItemStack(Femtocraft.itemIngotPlatinum),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemNanoSimulator),
  //                                                             new ItemStack(Femtocraft.itemCrossDimensionalCommunicator),
  //                                                             new ItemStack(Femtocraft.itemNanoSimulator),
  //                                                             new ItemStack(Femtocraft.itemNanoPlating),
  //                                                             new ItemStack(Femtocraft.blockNanoFabricator),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.blockMicroCable),
  //                                                             new ItemStack(Femtocraft.itemFluidicConductor),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.blockMicroCube),
  //                                                             new ItemStack(Femtocraft.itemNanoRegulator),
  //                                                             new ItemStack(Femtocraft.blockMicroCube),
  //                                                             new ItemStack(Femtocraft.itemNanoPlating),
  //                                                             new ItemStack(Femtocraft.blockMicroCube),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.blockNanoCable),
  //                                                             new ItemStack(Femtocraft.blockNanoCable),
  //                                                             new ItemStack(Femtocraft.itemManagerCore),
  //                                                             new ItemStack(Femtocraft.itemFluidicConductor),
  ...
  //                                            FemtocraftTechnologies.INDUSTRIAL_STORAGE))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemNanochip),
  //                                                             new ItemStack(Femtocraft.itemNanoPlating),
  //                                                             new ItemStack(Femtocraft.itemNanochip),
  //                                                             new ItemStack(Femtocraft.itemFluidicConductor),
  //                                                             new ItemStack(Femtocraft.itemNanoPlating),
  ...
  //                                            FemtocraftTechnologies.HARNESSED_NUCLEAR_DECAY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemLearningCore),
  ...
  //                                            FemtocraftTechnologies.HARNESSED_NUCLEAR_DECAY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemIngotFarenite), null,
  //                                                             new ItemStack(Femtocraft.itemIngotFarenite),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.ender_eye),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.magma_cream),
  //                                                             new ItemStack(Femtocraft.itemIngotMalenite),
  ...
  //                                            FemtocraftTechnologies.QUANTUM_INTERACTIVITY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.fire_charge),
  //                                                             new ItemStack(Femtocraft.itemIngotMalenite),
  ...
  //                                            FemtocraftTechnologies.QUANTUM_INTERACTIVITY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemMinosGate), null,
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](null, new ItemStack(Femtocraft.itemCerberusGate), null,
  ...
  //                                            FemtocraftTechnologies.QUANTUM_COMPUTING))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.slime_ball), null,
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemErinyesCircuit),
  ...
  //                                            FemtocraftTechnologies.QUANTUM_COMPUTING))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.gunpowder),
  //                                                             new ItemStack(Items.ghast_tear),
  ...
  //                                            FemtocraftTechnologies.QUANTUM_ROBOTICS))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemMinervaComplex),
  //                                                             new ItemStack(Femtocraft.itemIngotMalenite),
  //                                                             new ItemStack(Femtocraft.itemMinervaComplex),
  ...
  //                                            FemtocraftTechnologies.QUANTUM_COMPUTING))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.diamond),
  //                                                             new ItemStack(Femtocraft.itemErinyesCircuit),
  //                                                             new ItemStack(Items.diamond),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemOrpheusProcessor),
  //                                                             new ItemStack(Femtocraft.itemFemtoPlating),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemFemtoPlating),
  ...
  //                                            FemtocraftTechnologies.DEMONIC_PARTICULATES))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Items.diamond), new ItemStack(Items.diamond),
  //                                                             new ItemStack(Items.diamond),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemDimensionalMonopole),
  //                                                             new ItemStack(Items.ender_eye),
  //                                                             new ItemStack(Femtocraft.itemDimensionalMonopole),
  //                                                             new ItemStack(Items.ender_eye),
  //                                                             new ItemStack(Items.diamond),
  ...
  //                                            FemtocraftTechnologies.SPONTANEOUS_GENERATION))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemHerculesDrive),
  ...
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.blockSisyphusStabilizer),
  ...
  //                                            FemtocraftTechnologies.STELLAR_MIMICRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.itemStellaratorPlating),
  ...
  //                                            FemtocraftTechnologies.STELLAR_MIMICRY))
  //    addReversableRecipe(new AssemblerRecipe(Array[ItemStack](new ItemStack(Femtocraft.blockPlasmaConduit),
  //                                                             new ItemStack(Femtocraft.itemStellaratorPlating),
  //                                                             new ItemStack(Femtocraft.blockPlasmaConduit),
  //                                                             new ItemStack(Femtocraft.itemStellaratorPlating),
  //                                                             new ItemStack(Femtocraft.itemFemtoCoil),
