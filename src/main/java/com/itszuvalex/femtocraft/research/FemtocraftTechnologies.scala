...
object FemtocraftTechnologies {
  ...
  def defaultTechnologies: util.List[ITechnology] = {
    new util.ArrayList[ITechnology](util.Arrays.
        ...
        new Technology(BASIC_CIRCUITS, "Basic logic for basic machines.", EnumTechLevel.MACRO, Array[String](MACROSCOPIC_STRUCTURES), new ItemStack(Femtocraft.itemMicrochip), true, getInput(new ItemStack(Femtocraft.itemConductivePowder)), new ItemStack(Femtocraft.itemConductivePowder), null, "    Machines and mechanisms are worthless heaps of metal unless there is a purpose " + "behind them.  You have deduced a simple set of logical mechanisms and a simple means" + " of producing them.__Recipe.Crafting:Femtocraft:ItemConductivePowder--This powder balances the volatility of farenite with the stability of lapis, making it useful for conduction.____Recipe.Crafting:Femtocraft:ItemBoard--A " + "simple assembly of sticks, side-by-side, gives a base for mounting logic assemblies" + ".____Recipe.Crafting:Femtocraft:ItemPrimedBoard--Some conductive powder on the " + "board, when run through an oven, creates a foundation for circuitry.____Recipe" + ".Crafting:Femtocraft:ItemSpool--Just a thin rod of wood with end caps, " + "it makes an excellent storage unit for wires.____Recipe.Crafting:Femtocraft:ItemSpoolGold--Your studies show gold is an excellent conductor, " + "and you plan on using nothing but the highest quality for your machines.____Recipe" + ".Crafting:Femtocraft:ItemSpoolPlatinum--Some thin platinum wire on a spool.  " + "Useful for corrosive environments.____Recipe.Crafting:Femtocraft:ItemMicrochip--Thin wiring on a solid board, these multipurpose devices enable your" + " machines to perform basic logic.__", false, true),
        ...
        new Technology(SCIENTIFIC_THEORY, "Gentlemen, start your research!", EnumTechLevel.MACRO, Array[String](MACROSCOPIC_STRUCTURES), new ItemStack(Femtocraft.blockResearchConsole), true, null, null, null, "What is a scientist without the scientific method?  Luckily for you, " + "you no longer have to experiment.  This handy Research Computer analyzes all of your " + "knowledge and will theorize prototypes for you to make.  Stick these prototypes into the" + " " + "Research Console to have it analyze the potential uses and to store the standardized " + "blueprints into your knowledge store. __Recipe.Assembler:Femtocraft:BlockResearchComputer--Allows visual access to your personalized knowledge store.__" + "__Recipe" + ".Assembler:Femtocraft:BlockResearchConsole--Analyzes your prototypes and generates " + "standardized blueprints.__", false, true),
