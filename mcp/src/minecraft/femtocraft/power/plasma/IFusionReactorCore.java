...
public interface IFusionReactorCore extends IFusionReactorComponent {
    ...
    /**
     * @return Amount of power required to ignite.
     */
    int getIgnitionProcessThreshold();

    /**
     * @return Measure of how stable the reaction occuring in the core is.
     */
    int getReactionStability();

    /**
     * @return Plasma flow generated by this reactor.  Different reactors
    ...
    /**
     * @return Measurement of how stable the reactor core is.
     */
