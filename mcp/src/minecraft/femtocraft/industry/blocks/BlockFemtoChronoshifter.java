...
import femtocraft.industry.tiles.TileEntityFemtoChronoshifter;
...
public class BlockFemtoChronoshifter extends TileContainer {
    /**
    ...
    public BlockFemtoChronoshifter(int par1) {
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3,
        ...
        if (par1World.isRemote) {
            ...
            TileEntityFemtoChronoshifter tileentityfurnace =
