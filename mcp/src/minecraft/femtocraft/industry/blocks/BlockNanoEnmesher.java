...
import femtocraft.industry.tiles.TileEntityBaseEntityNanoEnmesher;
...
public class BlockNanoEnmesher extends TileContainer {
    /**
    ...
    public BlockNanoEnmesher(int par1) {
    ...
    public TileEntity createNewTileEntity(World par1World) {
        return new TileEntityBaseEntityNanoEnmesher();
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4,
                           int par5, int par6) {
        TileEntityBaseEntityNanoEnmesher tileEntity =
                (TileEntityBaseEntityNanoEnmesher)
                        par1World
        ...
        if (tileEntity != null) {
            ...
            if (tileEntity.isWorking()) {
                ItemStack itemstack = tileEntity.meshStack;
