...
public class BlockNanoFabricator extends TileContainer {
    /**
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3,
        ...
        if (par1World.isRemote) {
            ...
            TileEntityNanoFabricator tileentityfurnace = (TileEntityNanoFabricator) par1World
    ...
    public TileEntity createNewTileEntity(World par1World) {
        return new TileEntityNanoFabricator();
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4,
                           int par5, int par6) {
        TileEntityNanoFabricator tileEntity = (TileEntityNanoFabricator) par1World
                .getBlockTileEntity(par2, par3, par4);
