...
import femtocraft.industry.tiles.TileEntityFemtoEntangler;
...
public class BlockFemtoEntangler extends TileContainer {
    /**
    ...
    public BlockFemtoEntangler(int par1) {
    ...
    public TileEntity createNewTileEntity(World par1World) {
        return new TileEntityFemtoEntangler();
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4,
                           int par5, int par6) {
        TileEntityFemtoEntangler tileEntity =
