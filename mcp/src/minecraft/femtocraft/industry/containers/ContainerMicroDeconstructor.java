...
public class ContainerMicroDeconstructor extends Container
{
    ...
    public ContainerMicroDeconstructor(InventoryPlayer par1InventoryPlayer, MicroDeconstructorTile deconstructor)
    {
        ...
        for(int y = 0; y < 3; ++y)
        {
        	for(int x = 0; x < 3; ++x)
        	{
        		this.addSlotToContainer(new OutputSlot(deconstructor, x + y*3 + 1, 88 + x*18, 18 + y*18));
        	}
        }
    ...
    public void addCraftingToCrafters(ICrafting par1ICrafting)
    {
        ...
        par1ICrafting.sendProgressBarUpdate(this, 0, this.deconstructor.cookTime);
        par1ICrafting.sendProgressBarUpdate(this, 1, this.deconstructor.getCurrentPower());
        par1ICrafting.sendProgressBarUpdate(this, 2, this.deconstructor.getMassAmount());
    }
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int i = 0; i < this.crafters.size(); ++i)
        {
            ...
            {
                icrafting.sendProgressBarUpdate(this, 0, this.deconstructor.cookTime);
            }
            if(this.lastPower != this.deconstructor.getCurrentPower()) {
            	icrafting.sendProgressBarUpdate(this, 1, this.deconstructor.getCurrentPower());
            }
            if(this.lastMass != this.deconstructor.getMassAmount())
            {
            	icrafting.sendProgressBarUpdate(this, 2, this.deconstructor.getMassAmount());
            }
        }
...
//        }
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (FemtocraftRecipeManager.assemblyRecipes.canCraft(itemstack1))
                {
