...
public class FemtocraftAssemblerRecipeManager {
	...
	private void registerMicroDecompositionRecipes()
	{
		try
		{
			...
			if(configRegisterRecipe("Vine"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null, null, new ItemStack(Femtocraft.FibrousStrand),null,null,null,null,null,null}, 1, new ItemStack(Block.vine), TechLevel.MICRO, null));	
			...
			if(configRegisterRecipe("LilyPad"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null, null, null, new ItemStack(Femtocraft.FibrousStrand),null,null,null,null,null}, 1, new ItemStack(Block.waterlily), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Glowstone"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ConductiveAlloy),new ItemStack(Femtocraft.MineralLattice),null,null,null,null,null,null,null}, 1, new ItemStack(Block.whiteStone), TechLevel.MICRO, null));	
			...
			if(configRegisterRecipe("Apple"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.FibrousStrand),null,null,new ItemStack(Femtocraft.MorphicChannel),null,null,null,null,null}, 1, new ItemStack(Item.appleRed), TechLevel.MICRO, null));	
			...
			if(configRegisterRecipe("Feather"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.SpinyFilament),null,null,null,null,null,null,null,null}, 1, new ItemStack(Item.feather), TechLevel.MICRO, null));	
			...
			if(configRegisterRecipe("Seeds"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ReplicatingMaterial),null,null,null,null,null,null,null,null}, 1, new ItemStack(Item.seeds), TechLevel.MICRO, null));	
