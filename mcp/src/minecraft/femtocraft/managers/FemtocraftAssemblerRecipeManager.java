...
public class FemtocraftAssemblerRecipeManager {
	...
	private void registerMicroDecompositionRecipes()
	{
		try
		{
			...
			if(configRegisterRecipe("Glowstone"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ConductiveAlloy),new ItemStack(Femtocraft.IonicChunk),null,null,null,null,null,null,null}, 1, new ItemStack(Item.glowstone), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Melon"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.MorphicChannel),new ItemStack(Femtocraft.FibrousStrand),null,null,null,null,null,null,null}, 1, new ItemStack(Block.melon), TechLevel.MICRO, null));
			if(configRegisterRecipe("Vine"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null, null, null, new ItemStack(Femtocraft.FibrousStrand),null,null,null,null,null}, 1, new ItemStack(Block.vine), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Mycelium"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.FungalSpores),new ItemStack(Femtocraft.MineralLattice),null,null,null,null,null,null,null}, 1, new ItemStack(Block.mycelium), TechLevel.MICRO, null));
			if(configRegisterRecipe("LilyPad"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null, null, null, null, new ItemStack(Femtocraft.FibrousStrand),null,null,null,null}, 1, new ItemStack(Block.waterlily), TechLevel.MICRO, null));	
			if(configRegisterRecipe("EnderStone"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ConductiveAlloy),new ItemStack(Femtocraft.MineralLattice),null,null,null,null,null,null,null}, 1, new ItemStack(Block.whiteStone), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Cocoa"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.MorphicChannel),null,null,null,null,null,null,null,null}, 1, new ItemStack(Block.cocoaPlant), TechLevel.MICRO, null));
			if(configRegisterRecipe("Apple"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.FibrousStrand),null,new ItemStack(Femtocraft.MorphicChannel),null, null,null,null,null,null}, 1, new ItemStack(Item.appleRed), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Coal"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.MineralLattice),new ItemStack(Femtocraft.IonicChunk),null,null,null,null,null,null,null}, 1, new ItemStack(Item.coal), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Diamond"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.MicroCrystal, 8), new ItemStack(Femtocraft.IonicChunk, 8), new ItemStack(Femtocraft.MicroCrystal, 8), new ItemStack(Femtocraft.IonicChunk, 8), new ItemStack(Femtocraft.MicroCrystal, 8), new ItemStack(Femtocraft.IonicChunk, 8), new ItemStack(Femtocraft.MicroCrystal, 8), new ItemStack(Femtocraft.IonicChunk, 8), new ItemStack(Femtocraft.MicroCrystal, 8)}, 1, new ItemStack(Item.diamond), TechLevel.MICRO, null));	
			if(configRegisterRecipe("IronIngot"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.MetalComposite),null,null,null,null,null,null,null,null}, 1, new ItemStack(Item.ingotIron), TechLevel.MICRO, null));	
			if(configRegisterRecipe("GoldIngot"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.MetalComposite),new ItemStack(Femtocraft.HardenedBulb),null,null,null,null,null,null,null}, 1, new ItemStack(Item.ingotGold), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Stick"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null,null,null,null,null, new ItemStack(Femtocraft.FibrousStrand),null,null,null}, 1, new ItemStack(Item.stick), TechLevel.MICRO, null));	
			if(configRegisterRecipe("String"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ReplicatingMaterial),null,null,null,null,null,null,null,null}, 1, new ItemStack(Item.silk), TechLevel.MICRO, null));
			if(configRegisterRecipe("Feather"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null, new ItemStack(Femtocraft.SpinyFilament),null,null,null,null,null,null,null}, 1, new ItemStack(Item.feather), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Gunpowder"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.IonicChunk), new ItemStack(Femtocraft.NerveCluster),null,null,null,null,null,null,null}, 1, new ItemStack(Item.gunpowder), TechLevel.MICRO, null));
			if(configRegisterRecipe("Seeds"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null, new ItemStack(Femtocraft.ReplicatingMaterial),null,null,null,null,null,null,null}, 1, new ItemStack(Item.seeds), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Wheat"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ReplicatingMaterial),new ItemStack(Femtocraft.FibrousStrand),null,null,null,null,null,null,null}, 1, new ItemStack(Item.wheat), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Flint"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null,new ItemStack(Femtocraft.HardenedBulb),null,null,null,null,null,null,null}, 1, new ItemStack(Item.flint), TechLevel.MICRO, null));	
			if(configRegisterRecipe("RawPorkchop"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ReplicatingMaterial),new ItemStack(Femtocraft.NerveCluster),null,null,null,null,null,null,null}, 1, new ItemStack(Item.porkRaw), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Porkchop"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ProteinChain),null,null,null,null,null,null,null,null}, 1, new ItemStack(Item.porkCooked), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Redstone"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.IonicChunk),new ItemStack(Femtocraft.MineralLattice),null,null,null,null,null,null,null}, 1, new ItemStack(Item.redstone), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Snowball"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null,null,null,null,null,null,null,null, new ItemStack(Femtocraft.MineralLattice)}, 1, new ItemStack(Item.snowball), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Leather"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ProteinChain),new ItemStack(Femtocraft.SynthesizedFiber),null,null,null,null,null,null,null}, 1, new ItemStack(Item.leather), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Clay"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.IonicChunk),null,null,null,null,null,null,null,null}, 1, new ItemStack(Item.clay), TechLevel.MICRO, null));	
			if(configRegisterRecipe("SugarCane"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null,new ItemStack(Femtocraft.SynthesizedFiber),null,null,null,null,null,null,null}, 1, new ItemStack(Block.reed), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Slimeball"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.NerveCluster),null,null,null,null,null,null,null,null}, 1, new ItemStack(Item.slimeBall), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Egg"))			addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.NerveCluster),new ItemStack(Femtocraft.ReplicatingMaterial),null,null,null,null,null,null,null}, 1, new ItemStack(Item.egg), TechLevel.MICRO, null));	
			if(configRegisterRecipe("RawFish"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ReplicatingMaterial),null, null, new ItemStack(Femtocraft.NerveCluster),null,null,null,null,null}, 1, new ItemStack(Item.fishRaw), TechLevel.MICRO, null));	
			if(configRegisterRecipe("CookedFish"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ProteinChain),new ItemStack(Femtocraft.SpinyFilament),null,null,null,null,null,null,null}, 1, new ItemStack(Item.fishCooked), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Dye"))			addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ReplicatingMaterial),new ItemStack(Femtocraft.SynthesizedFiber),null,null,null,null,null,null,null}, 1, new ItemStack(Item.dyePowder, 1, OreDictionary.WILDCARD_VALUE), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Bone"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.ReplicatingMaterial),new ItemStack(Femtocraft.HardenedBulb),null,null,null,null,null,null,null}, 1, new ItemStack(Item.bone), TechLevel.MICRO, null));
			if(configRegisterRecipe("PumpkinSeeds"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.HardenedBulb),new ItemStack(Femtocraft.ReplicatingMaterial),null,null,null,null,null,null,null}, 1, new ItemStack(Item.pumpkinSeeds), TechLevel.MICRO, null));
			if(configRegisterRecipe("MelonSeeds"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null, new ItemStack(Femtocraft.HardenedBulb),new ItemStack(Femtocraft.ReplicatingMaterial),null,null,null,null,null,null}, 1, new ItemStack(Item.melonSeeds), TechLevel.MICRO, null));	
			if(configRegisterRecipe("RawBeef"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null, new ItemStack(Femtocraft.NerveCluster),new ItemStack(Femtocraft.ReplicatingMaterial),null,null,null,null,null,null}, 1, new ItemStack(Item.beefRaw), TechLevel.MICRO, null));	
			if(configRegisterRecipe("CookedBeef"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null, new ItemStack(Femtocraft.ProteinChain),null,null,null,null,null,null,null}, 1, new ItemStack(Item.beefCooked), TechLevel.MICRO, null));	
			if(configRegisterRecipe("RawChicken"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.NerveCluster),null,null,new ItemStack(Femtocraft.ReplicatingMaterial),null,null,null,null,null}, 1, new ItemStack(Item.chickenRaw), TechLevel.MICRO, null));	
			if(configRegisterRecipe("CookedChicken"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null,null,new ItemStack(Femtocraft.ProteinChain),null,null,null,null,null,null}, 1, new ItemStack(Item.chickenCooked), TechLevel.MICRO, null));	
			if(configRegisterRecipe("RottenFlesh"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.SpinyFilament),new ItemStack(Femtocraft.NerveCluster),null,null,null,null,null,null,null}, 1, new ItemStack(Item.rottenFlesh), TechLevel.MICRO, null));	
			if(configRegisterRecipe("EnderPearl"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null, new ItemStack( Femtocraft.IonicChunk),null,new ItemStack(Femtocraft.IonicChunk),new ItemStack(Femtocraft.OrganometallicPlate),new ItemStack(Femtocraft.IonicChunk),null,new ItemStack(Femtocraft.IonicChunk),null}, 1, new ItemStack(Item.enderPearl), TechLevel.MICRO, null));	
			if(configRegisterRecipe("GhastTear"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.NerveCluster),new ItemStack(Femtocraft.IonicChunk),null,null,null,null,null,null,null}, 1, new ItemStack(Item.ghastTear), TechLevel.MICRO, null));	
			if(configRegisterRecipe("NetherWart"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.FungalSpores),new ItemStack(Femtocraft.ReplicatingMaterial),null,null,null,null,null,null,null}, 1, new ItemStack(Item.netherStalkSeeds), TechLevel.MICRO, null));	
			if(configRegisterRecipe("SpiderEye"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.NerveCluster),new ItemStack(Femtocraft.OrganometallicPlate),null,null,null,null,null,null,null}, 1, new ItemStack(Item.spiderEye), TechLevel.MICRO, null));	
			if(configRegisterRecipe("BlazePowder"))	addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.MorphicChannel),new ItemStack(Femtocraft.MicroCrystal),null,null,null,null,null,null,null}, 1, new ItemStack(Item.blazePowder), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Emerald"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{new ItemStack(Femtocraft.MetalComposite),new ItemStack(Femtocraft.ConductiveAlloy),null,null,null,null,null,null,null}, 1, new ItemStack(Item.emerald), TechLevel.MICRO, null));	
			if(configRegisterRecipe("Carrot"))		addReversableRecipe(new FemtocraftAssemblerRecipe(new ItemStack[]{null, new ItemStack(Femtocraft.ReplicatingMaterial),new ItemStack(Femtocraft.FibrousStrand),null,null,null,null,null,null}, 1, new ItemStack(Item.carrot), TechLevel.MICRO, null));	
		...
		{
			Femtocraft.logger.log(Level.SEVERE, e.errMsg);
			Femtocraft.logger.log(Level.SEVERE, "Femtocraft failed to load Micro-tier Assembler Recipes!");
		}
	}
