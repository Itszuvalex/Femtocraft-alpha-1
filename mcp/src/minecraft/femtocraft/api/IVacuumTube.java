...
public interface IVacuumTube {
	...
	/**
	 * Clears this tube's Input, and clear appropriate flags (and tell other tubes to disconnect as well, if needed)
	 */
	public void clearInput();
	
	/**
	 * Clears this tube's Output, and clear appropriate flags (and tell other tubes to disconnect as well, if needed)
	 */
