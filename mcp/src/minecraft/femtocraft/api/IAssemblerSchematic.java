...
public interface IAssemblerSchematic {
	 ...
	 * 
	 * @param stack
	 *            ItemStack to encode recipe into
	 * @param recipe
	 *            Recipe to encode into itemStack
	 ...
	 * 
	 * @param stack
	 *            ItemStack to find uses remaining of - generally is remaining
	 *            damage
	 ...
	 * 
	 * @param stack
	 *            - ItemStack of this schematic.
	 * @return True if this schematic is still valid, false if schematic is no
	 *         longer valid (i.e. damage).
	 */
	boolean onAssemble(ItemStack stack);

	/**
	 * @param stack
	 *            ItemStack that is breaking down
	 * @return ItemStack that takes the place of @stack, if onAssemble() returns
	 *         false;
	 */
