...
//	
//	
//	private static final ResourceLocation achievementTextures = new ResourceLocation( Femtocraft.ID.toLowerCase(),
...
//		short short1 = 141;
//		short short2 = 141;
//		this.field_74117_m = this.guiMapX = this.field_74124_q = (double) (AchievementList.openInventory.displayColumn
//				* 24 - short1 / 2 - 12);
...
//					&& achievementList.contains(achievement.parentAchievement)) {
//				k3 = achievement.displayColumn * 24 - k + 11 + k1;
//				j3 = achievement.displayRow * 24 - l + 11 + l1;
//				j4 = achievement.parentAchievement.displayColumn * 24 - k + 11
//						+ k1;
//				l3 = achievement.parentAchievement.displayRow * 24 - l + 11
//						+ l1;
//				boolean flag5 = this.statFileWriter
//						.hasAchievementUnlocked(achievement);
//				boolean flag6 = this.statFileWriter
...
//				} else if (this.statFileWriter
//						.canUnlockAchievement(achievement2)) {
...
//						new Object[] { I18n
//								.getString(achievement1.parentAchievement
//										.getName()) });
...
//							l3,
//							this.statFileWriter
//									.canUnlockAchievement(achievement1) ? (achievement1
//									.getSpecial() ? -128 : -1) : (achievement1
//									.getSpecial() ? -8355776 : -8355712));
//		}
//
//		GL11.glEnable(GL11.GL_DEPTH_TEST);
//		GL11.glEnable(GL11.GL_LIGHTING);
