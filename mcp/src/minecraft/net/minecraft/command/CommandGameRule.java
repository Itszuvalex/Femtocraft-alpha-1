    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        ...
        else if (par2ArrayOfStr.length == 1)
        {
            ...
            if (gamerules1.hasRule(s))
            {
                ...
                par1ICommandSender.sendChatToPlayer(ChatMessageComponent.func_111066_d(s).func_111079_a(" = ").func_111079_a(s2));
            }
            else
            {
                notifyAdmins(par1ICommandSender, "commands.gamerule.norule", new Object[] {s});
        ...
        else if (par2ArrayOfStr.length == 0)
        {
            ...
            par1ICommandSender.sendChatToPlayer(ChatMessageComponent.func_111066_d(joinNiceString(gamerules2.getRules())));
        }
        else
        {
