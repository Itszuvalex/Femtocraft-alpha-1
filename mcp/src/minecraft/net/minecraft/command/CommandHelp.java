...
public class CommandHelp extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        ...
        par1ICommandSender.sendChatToPlayer(ChatMessageComponent.func_111082_b("commands.help.header", new Object[] {Integer.valueOf(j + 1), Integer.valueOf(i + 1)}).func_111059_a(EnumChatFormatting.DARK_GREEN));

        for (int l = j * b0; l < k; ++l)
        {
            icommand = (ICommand)list.get(l);
            par1ICommandSender.sendChatToPlayer(ChatMessageComponent.func_111077_e(icommand.getCommandUsage(par1ICommandSender)));
        }
