...
public class ServerCommandManager extends CommandHandler implements IAdminCommand
{
    ...
    public void notifyAdmins(ICommandSender par1ICommandSender, int par2, String par3Str, Object ... par4ArrayOfObj)
    {
        ...
        ChatMessageComponent chatmessagecomponent = ChatMessageComponent.func_111082_b("chat.type.admin", new Object[] {par1ICommandSender.getCommandSenderName(), ChatMessageComponent.func_111082_b(par3Str, par4ArrayOfObj)});
        ...
        if (flag)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                if (entityplayermp != par1ICommandSender && MinecraftServer.getServer().getConfigurationManager().areCommandsAllowed(entityplayermp.getCommandSenderName()))
                {
