...
class GuiScreenTemporaryResourcePackSelectSelectionList extends GuiSlot
{
    ...
    protected void elementClicked(int par1, boolean par2)
    {
        ...
        try
        {
            ...
            this.field_110511_b.func_110615_a(new ResourcePackRepositoryEntry[] {(ResourcePackRepositoryEntry)list.get(par1 - 1)});
    ...
    protected boolean isSelected(int par1)
    {
        ...
        return par1 == 0 ? list.isEmpty() : list.contains(this.field_110511_b.func_110609_b().get(par1 - 1));
    }
    ...
    protected void drawSlot(int par1, int par2, int par3, int par4, Tessellator par5Tessellator)
    {
        ...
        if (par1 == 0)
        {
            try
            {
                ...
                this.field_110512_a.drawString(GuiScreenTemporaryResourcePackSelect.func_130016_h(this.field_110512_a), packmetadatasection.func_110461_a(), par2 + 32 + 2, par3 + 12 + 10, 8421504);
            }
        ...
        {
            ResourcePackRepositoryEntry resourcepackrepositoryentry = (ResourcePackRepositoryEntry)this.field_110511_b.func_110609_b().get(par1 - 1);
            ...
            List list = GuiScreenTemporaryResourcePackSelect.func_110335_j(this.field_110512_a).listFormattedStringToWidth(resourcepackrepositoryentry.func_110519_e(), 183);
