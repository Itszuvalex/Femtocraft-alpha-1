...
public class GuiStats extends GuiScreen
{
    ...
    public void addHeaderButtons()
    {
        ...
        GuiButton guibutton;
        this.buttonList.add(guibutton = new GuiButton(2, this.width / 2 - 46, this.height - 52, 100, 20, I18n.func_135053_a("stat.blocksButton")));
        GuiButton guibutton1;
        this.buttonList.add(guibutton1 = new GuiButton(3, this.width / 2 + 62, this.height - 52, 100, 20, I18n.func_135053_a("stat.itemsButton")));
