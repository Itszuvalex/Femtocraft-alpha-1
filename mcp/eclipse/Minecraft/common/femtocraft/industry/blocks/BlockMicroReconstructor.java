...
public class BlockMicroReconstructor extends BlockContainer
{
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            MicroReconstructorTile tileentityfurnace = (MicroReconstructorTile)par1World.getBlockTileEntity(par2, par3, par4);
...
//        }
    ...
    {
        return new MicroReconstructorTile();
    }
...
//        }
    ...
    {
	    MicroReconstructorTile tileEntity = (MicroReconstructorTile)par1World.getBlockTileEntity(par2, par3, par4);
