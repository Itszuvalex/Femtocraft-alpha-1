...
public class BlockMicroDeconstructor extends BlockContainer
{
    ...
    public BlockMicroDeconstructor(int par1)
    {
        ...
        setUnlocalizedName("FemtocraftMicroDeconstructor");
        setHardness(3.5f);
    ...
    {
        return Femtocraft.FemtocraftMicroDeconstructor.blockID;
    }
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        frontIcon = par1IconRegister.registerIcon(Femtocraft.ID.toLowerCase() +":" + "MicroDeconstructor_front");
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            MicroDeconstructorTile tileentityfurnace = (MicroDeconstructorTile)par1World.getBlockTileEntity(par2, par3, par4);
...
//        {
//            ((MicroDeconstructorTile)par1World.getBlockTileEntity(par2, par3, par4)).setGuiDisplayName(par6ItemStack.getDisplayName());
//        }
    }
    ...
    {
	    MicroDeconstructorTile tileEntity = (MicroDeconstructorTile)par1World.getBlockTileEntity(par2, par3, par4);
