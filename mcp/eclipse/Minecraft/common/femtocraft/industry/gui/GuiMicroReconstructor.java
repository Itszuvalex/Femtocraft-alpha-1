...
{
	public static final ResourceLocation texture = new ResourceLocation(Femtocraft.ID.toLowerCase(), "textures/guis/Reassembler.png");
    private MicroReconstructorTile reconstructorInventory;

    public GuiMicroReconstructor(InventoryPlayer par1InventoryPlayer, MicroReconstructorTile tileEntity)
    {
...
//        }
        ...
        i1 = (this.reconstructorInventory.currentPower  * 60)/ this.reconstructorInventory.getMaxPower();
...
//        	image = Femtocraft.mass_block.stillIcon;
        	...
        	i1 = (this.reconstructorInventory.getMassAmount() * 60)/this.reconstructorInventory.getMassCapacity();
