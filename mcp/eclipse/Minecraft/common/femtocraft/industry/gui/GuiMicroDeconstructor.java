...
{
	public static final ResourceLocation texture = new ResourceLocation(Femtocraft.ID.toLowerCase(), "textures/guis/Disassembler.png");
    private MicroDeconstructorTile deconstructorInventory;

    public GuiMicroDeconstructor(InventoryPlayer par1InventoryPlayer, MicroDeconstructorTile tileEntity)
    {
